...
-- consider gsf and gvf
vim.keymap.set('n', 'gF', '<C-w><C-f>')
...
vim.keymap.set('n', '<leader>ww', '<Cmd>WinShift swap<Cr>', {desc="WinShift Swap"})


vim.keymap.set('n', '<leader>gd', '<c-w>]', {desc="[G]oto [D]efinition"})
-- C-W ] -- split to definition
